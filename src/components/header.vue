...
<<<<<<< HEAD
          ...
          { icon: "gavel", title: "Report a problem", link: "/report", allow: true  },
          { icon: "stars", title: "Popular @'s", link: "/popular", allow: true },
          { icon: "delete_forever", title: "Delete @'s", link: "/delete", allow: false  },
